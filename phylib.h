...
//2D coordinate for any type of vector
typedef struct {
    double x;
    double y;
} phylib_coord;
...
// structure for a hole (just position)
typedef struct {
    phylib_coord pos;
} phylib_hole;
...
//union for storing types of objects
typedef union {
...
//Function prototypes for constructors (Part 1)
...
//Utility Functions function prototypes (Part 2)
...
// Physics functions function prototypes (Part 3)
...
//Misc function for phylib_bounce to update acceleration
